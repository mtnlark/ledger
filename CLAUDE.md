...
- Transaction rows are emoji-free: category is shown as a small full-color dot + name in the row subtext (emoji chips remain elsewhere, e.g. Shared page and CategoryManager)
