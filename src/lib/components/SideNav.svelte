<script lang="ts">
	...
	import { Home, Wallet, PiggyBank, TrendingUp, BarChart3, Users, Settings, ChevronLeft, ChevronRight } from 'lucide-svelte';
	...
	const navItems: NavItem[] = [
		...
		{ href: '/networth', label: 'Net Worth', icon: TrendingUp as ComponentType },
